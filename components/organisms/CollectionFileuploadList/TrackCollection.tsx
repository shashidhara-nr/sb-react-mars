...
import { mockCollection } from '@lib/mock/mockCollection';
...
const TrackCollection = () => {
  ...
  const testIdPrefix = 'trackcollection-fileupload';
...
<section
      className={`${styles.tabContent} ${styles.accountsAndBalancesContainer}`}
...
<Grid
        ...
        data-testid={`${testIdPrefix}-search-row`}
      >
      ...
      <section className={styles.tableContainer}>
        ...
        <DownloadDebtorDialog
          ...
          title={`${t('download')} ${t('collectionsfileupload').toLowerCase()}`}
