...
import { ALL_RECORDS_TABLE_COLUMNS, ALL_RECORDS_TABLE_HEAD_CELLS } from './constant';
import UnpaidOptionFilterDialog from './UnpaidOptionFilterDialog';
import { mockUnpaid } from '@lib/mock/mockUnpaid';
    ...
    <section className={`${styles.tabContent} ${styles.accountsAndBalancesContainer}`}>
      ...
      <section className={styles.tableContainer}>
        ...
        <DownloadDebtorDialog
          ...
          title={`${t('download')} ${t('unpaidOptions').toLowerCase()}`}
        />
      </section>
  </section>
  );
};
export default UnpaidOption;
