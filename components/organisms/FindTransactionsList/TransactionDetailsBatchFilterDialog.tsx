...
export interface TransactionDetailsBatchFilterDialogProps {
  open: boolean;
...
export default function TransactionDetailsBatchFilterDialog({
  open,
  anchorEl,
  onClose,
  onApply,
  initialValues
}: TransactionDetailsBatchFilterDialogProps) {
