...
const ManageBillingAccounts = () => {
  ...
  const handleSubmit = (data: any) => {
    // Get account name from the details
    const accountName = billingAccountDetails?.accountName || 'Billing Account';
    // Redirect to success page in edit mode
    router.push(`/billing-accounts/success?mode=edit&name=${encodeURIComponent(accountName)}`);
  };
