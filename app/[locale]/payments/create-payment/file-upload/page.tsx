...
import PaymentFileUpload from '@molecules/BeneficiaryFileUpload/BeneficiaryFileUpload';
      ...
      <Box sx={{ p: 2, mb: -2 }}>
        <Breadcrumb
          links={[
            ...
            { href: '/payments/create-payment', label: 'Select a creation method' },
            {
              href: '/payments/create-payment/file-upload',
              label: 'File upload',
            },
          ]}
        />
        <Heading as="h4" fontSize="28px" style={{ marginTop: '16px', marginLeft: '10px' }}>
          Create a payment (file upload)
        </Heading>
      </Box>
...
//   const [fundingOption, setFundingOption] = useState('Populated');
...
//     if (fieldName === 'fundingOption') setFundingOption(String(value));
//   }, []);
...
//           }
//         >
//           <Typography sx={{ fontWeight: 700, fontSize: '26px', mb: 1.2 }}>File overwrite warning</Typography>
//           <Typography sx={{ color: '#2d3748', fontSize: '20px', lineHeight: 1.3 }}>
//             You are attempting to upload a duplicate file, which will overwrite the previous version of it.
//           </Typography>
//           <Typography sx={{ color: '#2d3748', fontSize: '20px', lineHeight: 1.3, mt: 1 }}>
...
//           }
//         >
//           <Typography sx={{ color: '#2d3748', fontSize: '18px', lineHeight: 1.35 }}>
//             The following data formatting errors have been found within the file you&apos;ve uploaded.
//           </Typography>
//           <Typography sx={{ color: '#2d3748', fontSize: '18px', lineHeight: 1.35, mt: 1 }}>
...
//       return (
//         <AlertModal
//           title="Payment submission warning"
//           onClose={() => setModalKind(null)}
//           icon={<ErrorOutlineIcon sx={{ color: '#d74f4f', fontSize: 56 }} />}
//           actions={
//             <>
...
//                   setUploadedFile((prev) => (prev ? { ...prev, corrected: true } : prev));
//                 }}
//               >
//                 RELOAD THE FILE
//               </Button>
...
//           </Typography>
//           <Typography sx={{ color: '#2d3748', fontSize: '18px', lineHeight: 1.35, mt: 1 }}>
//             Please either fix the source file and reload it, or fix errors in situ and then submit.
//           </Typography>
//         </AlertModal>
//       );
//     }
...
//             {
//               href: '/payments/create-payment/file-upload',
//               label: 'Create a payment (file upload)',
//             },
//           ]}
//         />
//         <Heading as="h4" fontSize="28px" style={{ marginTop: '16px', marginLeft: '10px' }}>
...
//               <Button buttonVariant="text" onClick={() => router.push('/payments' as any)}>
//                 GO TO PAYMENTS HUB
//               </Button>
...
//                   <UploadOutlinedIcon sx={{ color: '#0a43d6', fontSize: 50 }} />
//                   <Typography sx={{ color: '#2d3748', fontSize: '18px' }}>
//                     Drag a file or click here to upload a file
//                   </Typography>
//                 </Stack>
//               </Box>
...
//                 accept=".pdf,.doc,.docx"
//                 style={{ display: 'none' }}
//                 onChange={(event: ChangeEvent<HTMLInputElement>) => handleSelectedFile(event.target.files?.[0])}
//               />
...
//               {uploadedFile && (
//                 <Box sx={{ border: '1px solid #d8dce5', borderRadius: '8px', p: 1.5 }}>
//                   <Typography sx={{ fontSize: '16px', fontWeight: 500 }}>{uploadedFile.name}</Typography>
//                   <LinearProgress variant="determinate" value={uploadedFile.progress} sx={{ mt: 1, height: '5px' }} />
//                   <Typography
//                     sx={{
//                       mt: 0.8,
//                       fontSize: '13px',
//                       color:
//                         uploadedFile.hasErrors && !uploadedFile.corrected
//                           ? '#c62828'
...
//                     labelId: 'funding-option-select',
//                     onChange: (e: any) => handleSelectFieldChange('fundingOption', e.target.value),
//                   }}
//                   name="fundingOption"
//                   value={fundingOption}
//                   error={false}
